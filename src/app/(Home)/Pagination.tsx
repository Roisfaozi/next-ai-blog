...
function Pagination({ }: Props) {
  return (
    <div className="pt-5 border-t border-gray-200 border-opacity-30 sm:justify-between justify-center items-center gap-5 flex sm:flex-row flex-col w-full">
      <div className="Button justify-center items-center flex">
        <div className="ButtonBase justify-center items-center gap-2 flex">
          <IconArrowLeft />
          <div className="Text text-sm font-medium leading-tight">Previous</div>
        </div>
      </div>
      <div className="PaginationNumbers justify-start items-start gap-0.5 flex">
        ...
        <div className="PaginationNumberBase w-10 h-10 rounded-lg justify-center items-center flex">
          <div className="Content grow shrink basis-0 self-stretch p-3 rounded-lg justify-center items-center inline-flex">
            <div className="Number text-center text-sm font-medium leading-tight">2</div>
          </div>
        </div>
        <div className="PaginationNumberBase w-10 h-10 rounded-lg justify-center items-center flex">
          <div className="Content grow shrink basis-0 self-stretch p-3 rounded-lg justify-center items-center inline-flex">
            <div className="Number text-center text-sm font-medium leading-tight">3</div>
          </div>
        </div>
        <div className="PaginationNumberBase w-10 h-10 rounded-lg justify-center items-center flex">
          <div className="Content grow shrink basis-0 self-stretch p-3 rounded-lg justify-center items-center inline-flex">
            <div className="Number text-center text-sm font-medium leading-tight">...</div>
          </div>
        </div>
        <div className="PaginationNumberBase w-10 h-10 rounded-lg justify-center items-center flex">
          <div className="Content grow shrink basis-0 self-stretch p-3 rounded-lg justify-center items-center inline-flex">
            <div className="Number text-center text-sm font-medium leading-tight">8</div>
          </div>
        </div>
        <div className="PaginationNumberBase w-10 h-10 rounded-lg justify-center items-center flex">
          <div className="Content grow shrink basis-0 self-stretch p-3 rounded-lg justify-center items-center inline-flex">
            <div className="Number text-center text-sm font-medium leading-tight">9</div>
          </div>
        </div>
        <div className="PaginationNumberBase w-10 h-10 rounded-lg justify-center items-center flex">
          <div className="Content grow shrink basis-0 self-stretch p-3 rounded-lg justify-center items-center inline-flex">
            <div className="Number text-center text-sm font-medium leading-tight">10</div>
          </div>
        </div>
      </div>
      <div className="Button justify-center items-center flex">
        <div className="ButtonBase justify-center items-center gap-2 flex">
          <div className="Text text-sm font-medium leading-tight">Next</div>
          <IconArrowRight />
        </div>
      </div>
    </div>
