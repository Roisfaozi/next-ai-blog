"use client"
export function IconHamburger({ className, fill = 'white' }: any) {
  return (
    <svg
      className={`${className}`}
      fill="none"
    ...
    >
      <g className="g" clipPath="url(#clip0_614_1954)">
        <path
          className="path"
      ...
      <defs className="defs">
        <clipPath className="clip_path" id="clip0_614_1954">
          <rect className="rect" fill={fill} height="32" width="32" />
        </clipPath>
      </defs>
    </svg>
  )
