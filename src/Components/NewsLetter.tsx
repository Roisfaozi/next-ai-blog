  ...
  return (
    <div className="w-full">
      <div className=" flex-col justify-start items-center gap-6 flex">
        ...
        <p className="w-full text-center text-xl font-normal leading-[30px]">Subscribe to learn about new product features, the latest in technology, solutions, and updates.</p>
      </div>
